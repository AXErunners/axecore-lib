...
For detailed technical information about a block please visit [Blocks](https://axe-docs.github.io/en/glossary/block) on the Axe Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://axe-docs.github.io/en/developer-reference#block-headers) page on the Axe Developer Reference Wiki.
